...
The results in Figures \@ref(fig:densplot1)-\@ref(fig:densplot3) show that the contracts do not appear to manipulate the running variable.
...
As show in Figures \@ref(fig:fig3)-\@ref(fig:fig4),  
\newpage 
