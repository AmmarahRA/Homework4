...
Figure \@ref(fig:rdplot1) shows the estimates for the effect of star ratings for different bandwidths. 
...
The results from in Figures \@ref(fig:densplot1)-\@ref(fig:densplot3) show that

\newpage 

## Question 5
Not sure how to check for manipulation of running variable with specific plan characteristic. 
